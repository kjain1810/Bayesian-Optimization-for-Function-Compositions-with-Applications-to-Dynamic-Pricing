...
filename = sys.argv[1]
regret_file = f"./outputs/hogp_regret_{filename}.txt"
runtime_file = f"./outputs/hogp_runtime_{filename}.txt"
...
with gpt_settings.cholesky_jitter(1e-4):
    ...
    for i in range(n_batches):
        ...
        def hogp(train_X, train_Y, best_f, global_minima=-5.162126064300537):
            tic = time.monotonic()
