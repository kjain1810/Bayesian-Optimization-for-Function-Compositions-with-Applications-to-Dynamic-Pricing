...
filename = sys.argv[1]
regret_file = f"./outputs_pricing_2/regret_{filename}.txt"
runtime_file = f"./outputs_pricing_2/runtime_{filename}.txt"
...
with gpt_settings.cholesky_jitter(1e-4):
    ...
    for itr in range(n_batches):
        ...
        print(
            f"It {itr+1:>2}/{n_batches}, best obs.: "
